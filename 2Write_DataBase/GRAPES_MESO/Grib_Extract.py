...
if __name__=='__main__':
  ...
  cls_s2wd  = M2WD.Class_GRAPES_MESO_2Write_DataBase(0)
  #获取参数
  ...
  dyvar_save={"shortName":["acpcp","ncpcp","asnow","ptype","pwat","10u","10v","gust",
                           "2t","2d","vis","sp","orog"],
  ...
  for idy, seach_date in enumerate(ltdates):
    ...
    for ifrst_hour in ltforecast_hours:
      ...
      #输入文件名                                        
      sIn_file_name = "rmf.gra."+sBegin_Date_UTC+"%03d"%ifrst_hour+".grb2"
      #输入文件绝对路径
